...
<Header
  ...
  links={[
    ...
    {
      name: "Suppl. Material",
      url: "src/assets/supplementary_document.pdf",
      icon: "fa-solid:file-pdf",
    },
    {
      name: "Suppl. Video",
      url: "src/assets/supplementary_video.mp4",
...
<TwoColumns>
  <Figure slot="left">
    <img-comparison-slider value="70">
      <figure slot="first" class="before">
        <img src="src/assets/attacks/scene_04_nominal.webp" width="100%" />
        <figcaption>nominal</figcaption>
      </figure>
      <figure slot="second" class="after">
        <img src="src/assets/attacks/scene_04_critical.webp" width="100%" />
  ...
  <Figure slot="right">
    <img-comparison-slider value="70">
      <figure slot="first" class="before">
        <img src="src/assets/attacks/scene_03_nominal.webp" width="100%" />
        <figcaption>nominal</figcaption>
      </figure>
      <figure slot="second" class="after">
        <img src="src/assets/attacks/scene_03_critical.webp" width="100%" />
          <figcaption>critical</figcaption>
        </figure>
    </img-comparison-slider>
  </Figure>
...
<TwoColumns>
  <Figure slot="left">
    <img-comparison-slider value="70">
      <figure slot="first" class="before">
        <img src="src/assets/attacks/scene_05_nominal.webp" width="100%" />
        <figcaption>nominal</figcaption>
      </figure>
      <figure slot="second" class="after">
        <img src="src/assets/attacks/scene_05_critical.webp" width="100%" />
          <figcaption>critical</figcaption>
        </figure>
    </img-comparison-slider>
  </Figure>
  <Figure slot="right">
    <img-comparison-slider value="70">
      <figure slot="first" class="before">
        <img src="src/assets/attacks/scene_06_nominal.webp" width="100%" />
        <figcaption>nominal</figcaption>
      </figure>
      <figure slot="second" class="after">
        <img src="src/assets/attacks/scene_06_critical.webp" width="100%" />
          <figcaption>critical</figcaption>
        </figure>
    </img-comparison-slider>
  </Figure>
...
<TwoColumns>
  <Figure slot="left">
    <img-comparison-slider value="70">
      <figure slot="first" class="before">
        <img src="src/assets/attacks/scene_07_nominal.webp" width="100%" />
        <figcaption>nominal</figcaption>
      </figure>
      <figure slot="second" class="after">
        <img src="src/assets/attacks/scene_07_critical.webp" width="100%" />
          <figcaption>critical</figcaption>
        </figure>
    </img-comparison-slider>
  </Figure>
  <Figure slot="right">
    <img-comparison-slider value="70">
      <figure slot="first" class="before">
        <img src="src/assets/attacks/scene_08_nominal.webp" width="100%" />
        <figcaption>nominal</figcaption>
      </figure>
      <figure slot="second" class="after">
        <img src="src/assets/attacks/scene_08_critical.webp" width="100%" />
          <figcaption>critical</figcaption>
        </figure>
    </img-comparison-slider>
  </Figure>
...
<img loading="lazy" src="src/assets/pem_comparison/detr3d/v_mlp_gauss_detr3d_seq_15.webp" />
<img loading="lazy" src="src/assets/pem_comparison/bevformer/v_mlp_gauss_bevformer_seq_15.webp" />
<img loading="lazy" src="src/assets/pem_comparison/streampetr/v_mlp_gauss_streampetr_seq_15.webp" />

<img loading="lazy" src="src/assets/pem_comparison/detr3d/v_mlp_gauss_detr3d_seq_22.webp" />
<img loading="lazy" src="src/assets/pem_comparison/bevformer/v_mlp_gauss_bevformer_seq_22.webp" />
<img loading="lazy" src="src/assets/pem_comparison/streampetr/v_mlp_gauss_streampetr_seq_22.webp" />
